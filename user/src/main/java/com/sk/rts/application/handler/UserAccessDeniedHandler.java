...
@Component
@NullMarked
public class UserAccessDeniedHandler extends CustomRestHandler implements ServerAuthenticationEntryPoint, ServerAccessDeniedHandler {

    public UserAccessDeniedHandler(JsonMapper jsonMapper) {
        super(jsonMapper);
    }
